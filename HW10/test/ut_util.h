...
protected:
  void SetUp(){
    ...
    shapes.push_back(new Circle(2, "c1")); //area:4pi, per:4pi
    shapes.push_back(new Circle(1.5, "c2")); //area:2.25pi, per:3pi
    shapes.push_back(new ConvexPolygon(vecs1, "p1")); //area:1.5, per:2sqrt(5)+sqrt(2)
    shapes.push_back(new ConvexPolygon(vecs2, "p2")); //area:6, per:4+2sqrt(13)=11.2
  }
