...
TEST(VectorTest, test_operator_add_TA){
  double v1[] = {1, 2, 2};
  double v2[] = {2, 3, 4};
  double v3[] = {3, 4, 5};
  ...
  ASSERT_EQ(9, result.at(1));
  ASSERT_EQ(11, result.at(2));

  ASSERT_EQ(1, vec1.at(0));
  ASSERT_EQ(2, vec1.at(1));
  ASSERT_EQ(2, vec1.at(2));
  ASSERT_EQ(2, vec2.at(0));
  ASSERT_EQ(3, vec2.at(1));
  ASSERT_EQ(4, vec2.at(2));
  ASSERT_EQ(3, vec3.at(0));
  ASSERT_EQ(4, vec3.at(1));
  ASSERT_EQ(5, vec3.at(2));
}
...
TEST(VectorTest, test_operator_subtract_TA){
  double v1[] = {1, 2, 2};
  double v2[] = {2, -3, 0};
  double v3[] = {-4, 1, -1};
  ...
  Vector vec2(v2, 3);
  Vector vec3(v3, 3);
  Vector result = vec2 - vec1 - vec3;

  ASSERT_EQ(3, result.dim());
  ASSERT_EQ(5, result.at(0));
